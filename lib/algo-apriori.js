  ...
  for (const d of detailData) {
    ...
    if (!itemMap[key]) {
      itemMap[key] = {
        ...
        // PERBAIKAN: Utamakan membaca kolom nama_barang_nota snapshot bawaan detail_transaksi
        nama_barang: d.nama_barang_nota || d.barang?.nama_barang || d.nama_barang || 'Barang Terhapus',
        total_terjual: 0,
      };
    }
